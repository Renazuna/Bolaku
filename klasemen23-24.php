...
<head>
    ...
    <title>Premier League Standings 2023/24</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2 style="text-align: center;">Premier League Standings 2023/24</h2>
        <?php
        // API Endpoint untuk klasemen Premier League musim 2023/24
        $url = 'http://api.football-data.org/v4/competitions/PL/standings?season=2023';
