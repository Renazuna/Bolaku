...
<head>
    ...
    <title>Premier League Standings 2022/23</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2 style="text-align: center;">Premier League Standings 2022/23</h2>
        <?php
        // API Endpoint untuk klasemen Premier League musim 2022/23
