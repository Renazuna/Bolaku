...
<head>
    ...
    <title>Premier League Standings 2021/22</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2 style="text-align: center;">Premier League Standings 2021/22</h2>
        <?php
        // API Endpoint untuk klasemen Premier League musim 2021/22
        $url = 'http://api.football-data.org/v4/competitions/PL/standings?season=2021';
